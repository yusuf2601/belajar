...
_logo_line_7_ = ('%s          XX       %s|##%s/~~\%s####≠;;;%s/~~\%s;,|       %sXX'%(_M_,_H_,_U_,_H_,_U_,_H_,_M_))
_logo_line_8_ = ('%s        XX..X      %s|#%s|  %so  %s\%s##≠;%s/  %so  %s|.|      %sX..XX'%(_M_,_H_,_U_,_M_,_U_,_H_,_U_,_M_,_U_,_M_,))
_logo_line_9_ = ('%s      XX.....X     %s|##%s\____/%s##≠;%s\____/%s.,|    %sX.....XX'%(_M_,_H_,_U_,_H_,_U_,_H_,_M_))
