...
### Logo
_logo_line_1_ = ('%s  __   _____ __   __ '%(_M_))
...
_logo_line_6_ = ('%s┌─────────────────────────┐'%(_M_))
_logo_line_7_ = ('%s│ %s• %sfacebook :user.rtl    %s│'%(_M_,_P_,_H_,))
_logo_line_8_ = ('%s│ %s• %sInstagram:yusuf_maulana261%s│'%(_M_,_P_,_H_,))
_logo_line_9_ = ('%s│ %s• %sWa       :+6285640119704%s│'%(_M_,_P_,_H_,))
_logo_line_10 = ('%s└─────────────────────────┘'%(_M_))
