...
_logo_line_8_ = ('%s        XX..X      %s|#%s|  %so  %s\%s##≠;%s/  %so  %s|%s•|      %sX..XX'%(_M_,_H_,_M_,_M_,_M_,_H_,_M_,_M_,_M_,_H_,_M_,))
_logo_line_9_ = ('%s      XX.....X     %s|##%s\____/%s##≠;%s\____/%s.,|    %sX.....XX'%(_M_,_H_,_M_,_H_,_M_,_H_,_M_))
...
def _menu_dev_(_Dapunta_Ganteng_Banget_):
    ...
    _dapunta_cici_('%s────────────────────────────────────────────────'%(_K_))            
    _dapunta_menu__cici_dapunta__ = _cici_dapunta_('%s»»»» Pilih Cok : '%(_B_,_H_))
    _dapunta_cici_('')
